...
## Core Principles
* **Modernity:** Always use the latest stable versions of packages, frameworks, and APIs. Actively avoid deprecated methods. When working with LLM and AI Tools use latest model version.
...
* **Completeness:** Include appropriate tests, error handling, logging/metrics hooks, type hints, docstrings, and comments on complex logic.
